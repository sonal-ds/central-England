...
import  FaqAccordion  from "../components/common/FaqCards";
...
const Furnallocation: Template<LocationTemplateProps> = ({
	document,
	__meta,
	breadcrumbs,
...
{/* <FaqCard data={document.c_fAQ}/> */}
{/* <FaqAccordion data={document.c_fAQ}/> */}
						<NearByLocation
