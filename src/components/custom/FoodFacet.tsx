import {
  ...
  export default function FoodFacet(props: FacetProps): JSX.Element {
    const {
      facet,
      onToggle,
      searchable,
        ...
        <div className={cssClasses.optionsContainer}>
          {facetOptions.map((option) =>
            renderCheckboxOption({
              ...
              onClick: (isChecked) => onToggle(facet.fieldId, option, isChecked),
...
<button onClick={() => onToggle(facet.fieldId, facetOptions, false)}>Clear</button>
      </>
    );
  }
